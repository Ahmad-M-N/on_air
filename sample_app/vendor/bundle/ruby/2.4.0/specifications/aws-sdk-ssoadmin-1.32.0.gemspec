# -*- encoding: utf-8 -*-
# stub: aws-sdk-ssoadmin 1.32.0 ruby lib

Gem::Specification.new do |s|
  s.name = "aws-sdk-ssoadmin"
  s.version = "1.32.0"
  ...
  s.date = "2023-11-17"
  s.description = "Official AWS Ruby gem for AWS Single Sign-On Admin (SSO Admin). This gem is part of the AWS SDK for Ruby."
  s.email = ["aws-dr-rubygems@amazon.com"]
  s.homepage = "https://github.com/aws/aws-sdk-ruby"
  s.licenses = ["Apache-2.0"]
  s.required_ruby_version = Gem::Requirement.new(">= 2.3")
  s.rubygems_version = "2.5.0"
  s.summary = "AWS SDK for Ruby - SSO Admin"
