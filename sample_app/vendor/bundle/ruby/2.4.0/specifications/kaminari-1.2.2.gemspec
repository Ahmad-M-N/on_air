...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<kaminari-core>, ["= 1.2.2"])
      s.add_runtime_dependency(%q<kaminari-actionview>, ["= 1.2.2"])
      s.add_runtime_dependency(%q<kaminari-activerecord>, ["= 1.2.2"])
      ...
      s.add_dependency(%q<kaminari-core>, ["= 1.2.2"])
      s.add_dependency(%q<kaminari-actionview>, ["= 1.2.2"])
      s.add_dependency(%q<kaminari-activerecord>, ["= 1.2.2"])
